...
<div class="right_col" role="main">
              ...
              <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <td>{{$no++}}</td>
                    ...
                    <td> <a href="{{route('curriculum.edit', $curriculum->id)}}" class="btn btn-primary" type="submit" >Edit</a>
                     <a href="javascript:;" class="btn btn-danger"  data-toggle="modal" onclick="deleteData({{$curriculum->id}})" 
        ...
        <div class="col-md-6">
            ...
            @csrf()
                ...
                <div class="form-group">
                     ...
                     <select class="form-control" name="resources_id">
  ...
  <script type="text/javascript">
     ...
     {
         var id = id;
         var url = '{{ route("curriculum.destroy", ":id") }}';
